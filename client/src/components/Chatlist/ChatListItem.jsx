      ...
      <div className="min-h-full flex flex-col justify-center mt-3 pr-2 w-full">
              ...
              <div>
                <span 
                  ...
                  ${!data.totalUnreadMessage > 0 
                    ?   "text-secondary" : "text-icon-green"
                  } text-sm
                  `}>
        ...
        <div className="flex border-b border-conversation-border pb-2 pt-1 p3-2">
          <div className="flex justify-between w-full">
            <span className="text-secondary line-champ-1 text-sm">
                ...
                ">
                  ...
                  }
                  {
                    ...
                    <span className="flex gap-1 items-center">
                      <FaMicrophone className="text-panel-header-icon" /> Tin nhắn thoại
                    </span>
                  }
                  {
                    data.type === 'image' && 
                    <span className="flex gap-1 items-center">
                      <FaCamera className="text-panel-header-icon" /> Ảnh
                    </span>
                  }
                </div>
              )}
